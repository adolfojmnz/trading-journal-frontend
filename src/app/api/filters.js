...
export const getReportFilterParams = (filters) => {
  let filterParams = "";
  ...
  if (filters.indicator) {
    filterParams += `indicator=${filters.indicator}&`;
  }
  if (filters.impact) {
    filterParams += `impact=${filters.impact}&`;
  }
  if (filters.date) {
...
export const getIndicatorFilterParams = (filters) => {
  let filterParams = "";
...
export const getCountryFilterParams = (filters) => {
  let filterParams = "";
