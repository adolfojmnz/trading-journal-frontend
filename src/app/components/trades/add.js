...
const AddTrade = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <form onChange={handleChange} onSubmit={handleSubmit} method="POST" className="grid grid-cols-2 gap-4 w-full max-w-md">
        <div className="mb-2">
          <label className="block font-medium mb-1">Trade Ticket</label>
          <input type="text" name="ticket" className="w-full p-2 border border-gray-300" />
        </div>

        <div className="mb-2">
          <label className="block font-medium mb-1">Currency Pair</label>
          <select name="currency_pair" className="w-full p-2 border border-gray-300" >
        ...
        <div className="mb-2">
          ...
          <input max={100} min={0.01} step={0.01} defaultValue={0.01} type="number" name="volume" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Open DateTime</label>
          <input name="open_datetime" type="datetime-local" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Close DateTime</label>
          <input name="close_datetime" type="datetime-local" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Open Price</label>
          <input defaultValue={0.1} min={0} step={0.00001} type="number" name="open_price" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Take Profit</label>
          <input defaultValue={0.1} min={0} step={0.00001} type="number" name="take_profit" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Stop Loss</label>
          <input defaultValue={0.1} min={0} step={0.00001} type="number" name="stop_loss" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">Close Price</label>
          <input defaultValue={0.1} min={0} step={0.00001} type="number" name="close_price" className="w-full p-2 border border-gray-300" />
        </div>
        <div className="mb-2">
          <label className="block font-medium mb-1">PnL</label>
          <input defaultValue={0.1} min={0} step={0.01} name="pnl" type="number" className="w-full p-2 border border-gray-300" />
        </div>
