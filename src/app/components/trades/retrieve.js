...
const RetrieveTrade = () => {
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-gray-200">
            <th className="py-2 px-4 border-b w-1/9">Ticket</th>
            <th className="py-2 px-4 border-b w-2/9">
              Currency Pair
            </th>
            <th className="py-2 px-4 border-b w-1/9">Type</th>
            <th className="py-2 px-4 border-b  w-1/9">
              Open DateTime
            </th>
            <th className="py-2 px-4 border-b  w-1/9">
              Close DateTime
            ...
            <th className="py-2 px-4 border-b  w-1/9">Volume</th>
            <th className="py-2 px-4 border-b  w-1/9">PnL</th>
          </tr>
        </thead>
        <tbody>
          {trade !== null ? (
            <tr className="" key={trade.id}>
              <td className="py-2 px-4 border-b w-1/9">
                {trade.ticket}
              </td>
              <td className="py-2 px-4 border-b w-2/9">
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-center mb-4">Trade Details</h2>
      {error ? (
        <p className="">{error}</p>
      ) : (
