          ...
          <table className="trade-details-table w-full border-collapse">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="py-2 px-4 border-b text-left w-2/9">
                  Currency Pair
                </th>
                <th className="py-2 px-4 border-b text-left w-1/9">Type</th>
                <th className="py-2 px-4 border-b text-right w-1/9">
                  Open DateTime
                </th>
                <th className="py-2 px-4 border-b text-right w-1/9">
                  Close DateTime
            ...
            <tbody>
              {trade !== null ? (
                <tr className="trade-item" key={trade.id}>
                  <td className="py-2 px-4 border-b text-left w-1/9">
                    {trade.ticket}
                  </td>
                  <td className="py-2 px-4 border-b text-left w-2/9">
                    {trade.currency_pair}
                  </td>
                  <td className="py-2 px-4 border-b text-left w-1/9">
                    {trade.type === "S" ? "Short" : "Long"}
                  </td>
                  <td className="py-2 px-4 border-b text-right w-1/9">
                    {trade.open_datetime}
                  </td>
                  <td className="py-2 px-4 border-b text-right w-1/9">
